...
export default function NewQuoteForm({ profile, quote, bankAccounts, usage }: Props) {
  ...
  useEffect(() => {
    const dismissed = sessionStorage.getItem('renewdesk_quote_warn_dismissed')
    ...
    return (
      <>
        <div className="bg-white rounded-xl p-8 text-center" style={{ border: '1px solid rgba(0,0,0,0.08)' }}>
          ...
          <h2 className="text-base font-bold text-gray-900 mb-1">Monthly quote limit reached</h2>
          <p className="text-sm text-gray-500 mb-5">
            You&apos;ve used all {usage.limit} quotes for this month. Upgrade to Pro for unlimited quotes.
          </p>
          <button
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <span className="font-medium">
              You&apos;ve used {usage.current} of {usage.limit} free quotes this month.
            </span>{' '}
          ...
          <div className="flex items-center gap-2 flex-shrink-0">
            ...
            <button
              onClick={() => {
                ...
                sessionStorage.setItem('renewdesk_quote_warn_dismissed', '1')
              }}
